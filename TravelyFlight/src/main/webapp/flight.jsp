...
<div class="bg-custom">
		...
		<div align="center" class="topnav" style="
    display: flex;
">
			...
			<table>
				...
				<tr>
					<td><button type="submit" 
						style="text-decoration: none; padding-left: 12px;border: none; font-size: 17px; color: white;background-color:#002a4d">
							 My Bookings</button></td>
				</tr>
			</table>
			</form>
	...
	<%
	String flightName = "", cabin = "", from="",to="";
	%>
			...
			<tr style="border-bottom: solid thin darkgray;">
				...
				<form action="FlightName" method="post">
				    <input id="from" name="from" type="hidden"
						value="<%=from%>"> <input id="to"
						name="to" type="hidden" value="<%=to%>">
