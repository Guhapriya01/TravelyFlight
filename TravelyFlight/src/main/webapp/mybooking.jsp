...
<div class="bg-custom">
	...
	<div class="back-img">
		<div>
			<h1 align="center"
				style="padding-top: 30px; color: white; margin: 0px;">Your Bookings !</h1>
		</div>
	</div>
	...
	<table class="table table-bordered"
		...
		<tbody>
			...
			<tr style="border-bottom: solid thin darkgray;">
				<td id="val"><%=str[0]%></td>
				<td style="text-align: center; padding-top: 3%;"><b><%=str[1]%> to <%=str[2]%> </b>
				</td>
				<td style="text-align: center; padding-top: 3%;"> Total Cost :  <span>&#8377;</span>  <b>  <%=str[5]%> </b></td>
				<td style="text-align: center; padding-top: 3%;">Cabin : <b><%=str[4]%></b>
				</td>
				<td style="text-align: center; padding-top: 3%;"><b> Date :  <%=str[3]%> </b></td>
